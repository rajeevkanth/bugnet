...
- ✅ 01-prerequisites: Verify prerequisites and SDK toolchain ([Content](tasks/01-prerequisites/task.md), [Progress](tasks/01-prerequisites/progress-details.md))
- ✅ 02-sdk-style-conversion: Convert all projects from legacy to SDK-style csproj ([Content](tasks/02-sdk-style-conversion/task.md), [Progress](tasks/02-sdk-style-conversion/progress-details.md))
- 🔄 03-foundation-libs: Upgrade Tier 0 foundation libraries to net10.0 ([Content](tasks/03-foundation-libs/task.md))
